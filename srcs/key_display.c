...
/*   Updated: 2019/01/15 11:24:10 by gfranco          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	manip(t_m *m)
{
	...
	mlx_string_put(m->ptr, m->win, 5, 130, 0x139BE9, "*  Zoom :    + & -    *");
	mlx_string_put(m->ptr, m->win, 5, 110, 0x13AFE9, "*  Move :    Arrows   *");
	mlx_string_put(m->ptr, m->win, 5, 150, 0x1387E9, "*  Clean :   clear    *");
	mlx_string_put(m->ptr, m->win, 5, 170, 0x1373E9, "*  Para :      P      *");
	mlx_string_put(m->ptr, m->win, 5, 190, 0x1373E9, "*  Iso :       [      *");
	mlx_string_put(m->ptr, m->win, 5, 210, 0x1373E9, "* * * * * * * * * * * *");
}
